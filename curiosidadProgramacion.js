...
const languageFacts = {
   javascript: [
    ...
    python:[
        ...
        "Es muy versátil por lo que tiene múltiples áreas de aplicación como: inteligencia artificial, Big Data y desarrollo web.",
       
        ],
    php:[
         "Es un lenguaje de programación multipropósito que permite desarrollar aplicaciones del lado del servidor,",
         "garantizando una excelente comunicación con la web.",
         ],
    swift:[
    ...
    matlab:[
        " Es un lenguaje de programación orientado al cálculo matricial, implementación de algoritmos, visualización de datos y creación de interfaces de usuario.",
        ],
...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Puedo darte datos curiosos de algun lenguaje de programación,solo tienes que mencionarlo, por ejemplo, prueba diciendo "JavaScript""java""Python""PHP""Swift""Matlab"';
